...
<!-- Temoin Field -->
<div class="form-group col-sm-6">
    {!! Form::label('temoin', 'Temoin:') !!}
    {!! Form::text('temoin', null, ['class' => 'form-control','maxlength' => 30,'maxlength' => 30]) !!}
</div>

<!-- Autorite Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Autorite', 'Autorité:') !!}
    {!! Form::text('Autorite', null, ['class' => 'form-control','maxlength' => 30,'maxlength' => 30]) !!}
</div>
...
<div class="form-group col-sm-12">
    {!! Form::submit('Enregistre', ['class' => 'btn btn-primary','id'=>'suprimer']) !!}
    <a href="{{ route('reunificcations.index') }}" class="btn btn-default">Annuler</a>
</div>
